...
<div style="margin: 0 auto; text-align: center;">
	<label id="L1"><input  type="text" placeholder="请输入标题" id="title" name="title" autocomplete="off"></label>
...
<script>
    ...
    function submit_atricle() {
        var title = $("#title").val();
        var createUserId = ${userInfo.id};
        var htmlContent = $("#editor-md-html").val();
        var markdownContent = $("#editor-md-doc").val();
        $.ajax({
            url: "/user/post",
            data: JSON.stringify({createUserId: createUserId,title: title, htmlContent: htmlContent, markdownContent: markdownContent}),
            type: "POST",
